...
class Redshift_Evolution(Initialize):
	...
	def __init__(self, MCMC_H0, MCMC_ombh2, MCMC_omch2, sigma_8, MCMC_ns, MCMC_esc_PopII, MCMC_esc_PopIII, MCMC_lambda_0):
		
		
		super(Redshift_Evolution, self).__init__(MCMC_H0, MCMC_ombh2, MCMC_omch2, sigma_8, MCMC_ns, MCMC_esc_PopII, MCMC_esc_PopIII, MCMC_lambda_0, initial_call=True, zcoll=Z[0])
	...
	def quntity_for_MCMC(self):	
		...
		#else:
		return self.redshift_array, self.Q_HII, self.tau, self.dNLLdz_array, self.gamma_PI, self.Q_HII[96]
